...
public class EquipeServiceImplMockTest {
    ...
    @InjectMocks
    IEquipeServiceImpl equipeService;
    ...
    public void testRetrieveAllEquipes() {
        ...
        List<Equipe> retrievedEquipes = equipeService.retrieveAll();
    ...
    public void testRetrieveEquipe() {
        ...
        Equipe equipe1 = equipeService.retrieveById(2);
    ...
    public void testAddEquipe() {
        ...
        // Call the method you want to test.
        Equipe addedEquipe = equipeService.add(newEquipe);
